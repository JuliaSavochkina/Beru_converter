...
1. В проекте re:revisor в файле 20924_beru.yml изменить даты в uri для EP части.
...
[ничего не комитьте!]          
2. Запустить проект и локально запросить EP для программы 20924. Полученный файл можно перенести в текущий проект.
